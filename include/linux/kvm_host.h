...
enum kvm_exec_mapped_exit_profile_boundary {
	...
	KVM_EXEC_PROFILE_VMX_IO_DISPATCH = 15,
	KVM_EXEC_PROFILE_FAST_PIO_OUT = 16,
	KVM_EXEC_PROFILE_PIO_BUS_MISS = 17,
	KVM_EXEC_PROFILE_PIO_EXIT_READY = 18,
	KVM_EXEC_PROFILE_FAST_PIO_OUT_READY = 19,
