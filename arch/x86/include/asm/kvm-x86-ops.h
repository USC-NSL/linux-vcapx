...
KVM_X86_OP_OPTIONAL_RET0(exec_posted_interrupt_supported)
KVM_X86_OP_OPTIONAL_RET0(exec_deliver_posted_interrupt)
KVM_X86_OP_OPTIONAL_RET0(exec_posted_interrupt_pending)
